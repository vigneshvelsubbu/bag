 ...
 *
 * Note: This function is used to augment the Object type in Bag expressions. See
 * {@link angular.Object} for more information about Bag arrays.
 *
 ...
 *
 * Note: this function is used to augment the Object type in Bag expressions. See
 * {@link ng.$filter} for more information about Bag arrays.
 *
  ...
  this.$get = ['$parse', function($parse) {
     ...
     *
       <pre>
         ...
         expect(exp({name:'Bag'}).toEqual('Hello Bag!');
       </pre>
     *
     *
...
var inputType = {
   ...
   * @param {string=} ngChange Bag expression to be executed when input changes due to user
